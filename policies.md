...
Homeworks are due by 11:59 PM on the due date. Throughout the semester, you may
turn in 2 of the homeworks up to 24 hours late. Otherwise, no credit will be
received for late homeworks. If you have extenuating circumstances (illness,
travel, etc.), please let me know *before* the homework due date, and we can
discuss accomodations.

Homeworks will be graded on a 4-point scale:

* 0 - not turned in
* 1 - major issues (e.g., code doesn't run or several answers not correct)
* 2 - minor issues (answers are mostly correct)
* 3 - all correct solutions
...
Most importantly, you should be sure that you are learning the material covered in the homework assignments. The concepts and mathematics from the homeworks will appear on in-person quizzes and the final exam. The best way to do well in the class is to struggle through the homeworks yourself to get a deep understanding of the material.

There must be no collaboration and no use of internet or electronic devices for
in-person quizzes and the final exam.
